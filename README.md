...
### v1.3.2 — Surface Refresh, Operator Workflows, and ECC 2.0 Alpha (Apr 2026)
...
**That's it!** You now have access to 60 agents, 228 skills, and 76 legacy command shims.
...
| **Commands** | 76 | Shared | Instruction-based | 35 |
...
| **Version** | Plugin | Plugin | Reference config | 1.3.2 |
