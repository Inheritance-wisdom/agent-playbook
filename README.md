...
### v1.3.0 — Surface Refresh, Operator Workflows, and ECC 2.0 Alpha (Apr 2026)
...
**That's it!** You now have access to 60 agents, 225 skills, and 76 legacy command shims.
...
| **Version** | Plugin | Plugin | Reference config | 1.3.0 |
